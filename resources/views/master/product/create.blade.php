                ...
                <form action="{{ route('product.store') }}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" value="{{ old('product_stock') }}" name="product_stock" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" value="{{ old('product_price') }}" name="product_price" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" value="{{ old('product_exp') }}" name="product_exp" class="form-control">
                            </div>
                        </div>
                    </div>
